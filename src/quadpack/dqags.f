      subroutine dqags(f, params, a,b,epsabs,epsrel,result,abserr,
...
c            params - double precision
c                     array of params of the function
c
...
c
      ...
      l3 = limit+l2
c
      call dqagse(f,params,a,b,epsabs,epsrel,limit,result,abserr,
