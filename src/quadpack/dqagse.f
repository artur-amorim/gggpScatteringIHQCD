      subroutine dqagse(f,params,a,b,epsabs,epsrel,limit,result,abserr,
...
c
     ...
     *  res3la,rlist,rlist2,small,uflow, params
...
c
      ...
      oflow = d1mach(2)
      ierro = 0
      call dqk21(f,params,a,b,result,abserr,defabs,resabs)
c
c           test on accuracy.
c
      dres = dabs(result)
...
c
        ...
        b2 = blist(maxerr)
        erlast = errmax
        call dqk21(f,params,a1,b1,area1,error1,resabs,defab1)
        call dqk21(f,params,a2,b2,area2,error2,resabs,defab2)
c
