...
int main(int argc, char ** argv)
{
    ...
    if(argc < 12)
    {
        ...
        cout << "Program usage: " + string(argv[0]) + " f2_path sigma_gp_path invls a b c d k1 k2 k3 k4" << endl;
        cout << "Using default values." << endl;
    }
    else
    {
        f2_path = argv[1]; sigma_gp_path = argv[2];
    ...
    auto f = [&f2, &sigma_gp, &f2_pts, &sigma_gp_pts, &hard] (const std::vector<double> & X)
    {
        ...
        double chi2 = F2_chi2 + sigma_gp_chi2;
        cout << "chi2: " << chi2 << endl; 
        return chi2;
    };
