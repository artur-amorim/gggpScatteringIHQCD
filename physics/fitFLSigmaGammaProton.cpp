...
int main(int argc, char ** argv)
{
    ...
    if(argc < 12)
    {
        ...
        cout << "Program usage: " + string(argv[0]) + " fl_path sigma_gp_path invls a b c d k1 k2 k3 k4" << endl;
        cout << "Using default values." << endl;
    }
    else
    {
        fl_path = argv[1]; sigma_gp_path = argv[2];
    ...
    auto f = [&fl, &sigma_gp, &fl_pts, &sigma_gp_pts, &hard] (const std::vector<double> & X)
    {
        ...
        double chi2 = FL_chi2 + sigma_gp_chi2;
        cout << "chi2: " << chi2 << endl; 
        return chi2;
    };
