...
# physics code
physics: bin/fitF2Photon_HardPomeron_4Reggeons.exe bin/fitSigma_HardPomeron_2Reggeons.exe bin/fitSigma_HardPomeron_4Reggeons.exe bin/fitSigma_SoftPomeron.exe bin/fitSigmaF2Photon_HardPomeron_4Reggeons.exe physics/predictStructureFunctions.exe
